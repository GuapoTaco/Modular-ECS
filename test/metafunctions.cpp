...
BOOST_AUTO_TEST_CASE(get_index_of_first_matching_test)
{
	...
	BOOST_TEST(GET_HANA_CONSTANT_VALUE(get_index_of_first_matching(tup, boost::hana::type_c<int>)) == 0);
	BOOST_TEST(GET_HANA_CONSTANT_VALUE(get_index_of_first_matching(tup, boost::hana::type_c<char>)) == 1);
	BOOST_TEST(GET_HANA_CONSTANT_VALUE(get_index_of_first_matching(tup, boost::hana::type_c<double>)) == 2);
}
...
BOOST_AUTO_TEST_CASE(remove_dups_test1)
{
	...
	BOOST_TEST(GET_HANA_CONSTANT_VALUE(boost::hana::contains(removed, boost::hana::type_c<double>)));
